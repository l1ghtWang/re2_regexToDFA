...
// // std::string regexFileNameTemp("/home/wygzero/re2/ANMLZoo_regex/clamAV/clamAV_re1.regex");
...
//   std::string s = readFileIntoString(regexFileNameTemp);
//   // std::string s = "\\x8a";
//   // std::string s = "\\x61";
...
//   std::string pattern_str = "\\x8a";
//   // std::string pattern_str = "\\x61";

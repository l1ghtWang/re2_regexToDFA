...
/* ---------class Input------------ */
    ...
    std::string regexFileName = "/home/yugwang/re2_regexToDFA/ANMLZoo_regex/regex_EESpec/newSnort/snort_yug.regex";

    std::string inputFileName("/home/share/networkpasckages/newSnort_input_1200MB_1.in");

    std::string tableFileName;
    std::string acFileName;
    
    void writeTableAC_toFile(int DFA_index, int numState, int numSymbol, vector<int> table, vector<int> ac)
    {
...
TEST(SingleThreaded, BuildEntireDFA) {
    ...
    int targetNum_10_8levelFSM = 3;
    int num_10_7levelFSM = 0;
    int targetNum_10_7levelFSM = 4;
    int num_10_6levelFSM = 0;
    int targetNum_10_6levelFSM = 3;
    int num_10_5levelFSM = 0;
    int targetNum_10_5levelFSM = 2;
	...
	{
		//randomly select a regex from regex_list
		...
		int ground_true_state [profile_point];
		int correctCount = profile_point;
		for (int i = 0; i < profile_point; i++)
		{
		...
		float averageConvergenceLen = ((profile_point-correctCount==0)? 0:1.0*sumConvergenceLen/(profile_point-correctCount));
		...
		{
			writeTableAC_toFile(num_10_8levelFSM, numStates, nSymbol_, table, ac);
			num_10_8levelFSM += 1;
		}
		else if(averageConvergenceLen > 5000000 && num_10_7levelFSM != targetNum_10_7levelFSM)
		{
			
			int dfa_index = dfa_baseIdx+targetNum_10_8levelFSM+num_10_7levelFSM;
			writeTableAC_toFile(dfa_index, numStates, nSymbol_, table, ac);
			num_10_7levelFSM += 1;
		}
		else if(averageConvergenceLen > 500000 && num_10_6levelFSM != targetNum_10_6levelFSM)
		{
			int dfa_index = dfa_baseIdx+targetNum_10_8levelFSM+targetNum_10_7levelFSM+num_10_6levelFSM;
			writeTableAC_toFile(dfa_index, numStates, nSymbol_, table, ac);
			num_10_6levelFSM += 1;
		}
		else if(averageConvergenceLen > 50000 && num_10_5levelFSM != num_10_5levelFSM)
		{
